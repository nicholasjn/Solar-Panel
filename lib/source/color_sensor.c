...
int32_t blackThreshold[6] = {4080, 4080, 4080, 4080, 4080, 4080};
int32_t whiteThreshold[6] = {700, 700, 700, 700, 700, 700};
...
void tesAdc(void){
	...
	while(!button3Pressed()){
		lcd_clear();
		char temp1[16], temp2[16];
		uint8_t i, black = 0, line = 0, gray = 0;
